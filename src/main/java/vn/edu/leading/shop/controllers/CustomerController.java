...
public class CustomerController {
    ...
    {
        model.addAttribute("customerModel",customerService.findByAId(id));
    ...
    public String save(@Valid CustomerModel customer, BindingResult result, RedirectAttributes redirect)
    {
        ...
        redirect.addFlashAttribute("successMessage","Saved customers successfully!");
        return "redirect:/customers";
    }
    ...
    public String detele(@PathVariable Long id, RedirectAttributes redirect)
    {
        ...
        {
            redirect.addFlashAttribute("successMessage","Delete customers successfully!");
            return "redirect:/customers";
        }
        else
        {
